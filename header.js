...
header.innerHTML=`<div class="siteHeader-inner"><a class="siteHeader-brand" href="${en?'/en/':'/'}"><span aria-hidden="true">🚀</span> KUP SI <b>APKU</b></a><div class="siteHeader-languages" aria-label="${en?'Language':'Jazyk'}"><a href="${en?pair[0]:pair[1]}" lang="${en?'cs':'en'}" aria-label="${en?'Přepnout do češtiny':'Switch to English'}" title="${en?'Čeština':'English'}"><span class="siteHeader-flag ${en?'siteHeader-flagCZ':'siteHeader-flagGB'}" aria-hidden="true"></span></a></div><button class="siteHeader-toggle" type="button" aria-expanded="false" aria-controls="site-navigation" aria-label="${en?'Open menu':'Otevřít menu'}"><span aria-hidden="true">☰</span></button><nav class="siteHeader-nav" id="site-navigation" aria-label="${en?'Main navigation':'Hlavní navigace'}"><a href="${en?'/en/index.html#apps':'/index.html#apps'}">${en?'Apps':'Aplikace'}</a><a href="${en?'/en/index.html#showcase':'/index.html#showcase'}">${en?'Showcase':'Ukázky'}</a><a href="${en?'/en/index.html#how':'/index.html#how'}">${en?'How it works':'Jak to funguje'}</a><a href="${en?'/en/index.html#faq':'/index.html#faq'}">FAQ</a><a href="${en?'/en/index.html#about':'/index.html#about'}">${en?'About me':'O mně'}</a><a href="${en?'/en/doporucit.html':'/doporucit.html'}">${en?'Refer & earn':'Doporučit a vydělat'}</a><a href="${en?'/en/prispet.html':'/prispet.html'}">${en?'Contribute':'Přispět'}</a><a href="${en?'/en/index.html#checkout':'/index.html#checkout'}">${en?'Order':'Objednat'}</a><a href="${en?'/en/ucet.html':'/ucet.html'}">${en?'My account':'Můj účet'}</a><a class="siteHeader-cart" data-cart-checkout href="${en?'/en/index.html#checkout':'/index.html#checkout'}"><span aria-hidden="true">🛒</span> ${en?'Cart':'Košík'} <strong data-cart-count>0</strong></a></nav></div>`;
